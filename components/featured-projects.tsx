...
export default function FeaturedProjects({ projects, featuredLabel = "(Featured)" }: FeaturedProjectsProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-[1600px] px-6 py-24 sm:px-10 md:py-32 lg:px-16">
        {/* (Featured) label */}
        <motion.div
          ...
          {projects.map((project, index) => (
            ...
            >
              <motion.div
                ...
                className="group border-t border-white/15 py-5 md:py-6 cursor-pointer"
              >
                <div className="flex items-center justify-between gap-4">
                  <div className="flex min-h-[92px] w-full max-w-[680px] items-center rounded-2xl border border-white/10 bg-black/30 px-4 py-3 backdrop-blur-md md:min-h-[108px] md:px-5 md:py-4">
                    <div className="flex flex-col gap-2">
                      <span
                        className={`font-serif text-xl font-normal leading-tight transition-opacity duration-300 md:text-2xl lg:text-3xl ${
