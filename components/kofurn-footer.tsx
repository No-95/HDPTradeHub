        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/hdpholdings" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="flex h-12 w-12 items-center justify-center rounded-full border border-[#1877F2]/90 bg-[#1877F2]/55 text-[#F4F9FF] shadow-[0_0_0_1px_rgba(24,119,242,0.35),0_14px_36px_rgba(24,119,242,0.55)] backdrop-blur-md transition-all hover:scale-110 hover:bg-[#1877F2]/75">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://www.linkedin.com/in/hdp-holdings-co-ltd-77a630190/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="flex h-12 w-12 items-center justify-center rounded-full border border-[#0A66C2]/90 bg-[#0A66C2]/55 text-[#F4F9FF] shadow-[0_0_0_1px_rgba(10,102,194,0.35),0_14px_36px_rgba(10,102,194,0.55)] backdrop-blur-md transition-all hover:scale-110 hover:bg-[#0A66C2]/75">
                <Linkedin className="w-5 h-5" />
              </a>
              <a href="https://www.youtube.com/@HDPHOLDINGS" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="flex h-12 w-12 items-center justify-center rounded-full border border-[#FF0000]/90 bg-[#FF0000]/52 text-[#FFF2F2] shadow-[0_0_0_1px_rgba(255,0,0,0.35),0_14px_36px_rgba(255,0,0,0.55)] backdrop-blur-md transition-all hover:scale-110 hover:bg-[#FF0000]/72">
